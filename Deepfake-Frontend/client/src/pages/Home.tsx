...
import { ShieldAlert, Activity, FileVideo, FileAudio, Image as ImageIcon, ArrowRight } from "lucide-react";
import { Button } from "@/components/ui/button";

export default function Home() {
  const stats = [
    { label: "Models Loaded", value: "3/3", status: "Active" },
    { label: "Average Latency", value: "1.2s", status: "Optimal" },
    { label: "API Connection", value: "Online", status: "Stable" },
  ];
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border bg-card p-8 md:p-12">
        ...
        <div className="relative z-10 max-w-2xl space-y-6">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
            Upload images, video, or audio files for instant deepfake analysis. Our neural pipeline fuses multiple modalities for enterprise-grade detection accuracy.
          </p>
